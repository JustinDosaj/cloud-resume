...
const projects = [
  ...
  {
    name: 'Cloud Résumé',
    description: 'Deployed my résumé website using AWS services such as S3, DynamoDB, CloudFront, Lambda, and API Gateway.',
    link: { href: cloudResumeUrl, label: 'www.github.com' },
    logo: cloudResumeLogo,
  },
  {
    name: 'Zesti AI',
    description: 'Collaborated on the planning and development of an interactive web application that converts social media cooking videos into organized recipes.',
    link: { href: zestiUrl, label: 'www.zesti.ai' },
    logo: zestiLogo,
  },
  {
    name: 'Vurge LLC',
    description: 'A web app development company I founded as a solo venture, where I built custom web applications for clients across diverse industries, such as Web3 and music. No longer active.',
    link: { href: vurgeUrl, label: 'www.vurge.io' },
    logo: vurgeLogo,
  },
  {
    name: 'Stormgate Tactics',
    description: 'Web app for Stormgate game that allows players to look-up and post builds. The app includes a blog, dynamic search & filtering, user authentication and more.',
